...
public class DebugWordRepository implements WordRepository {
    ...
    private Word[] words = {
            ...
            new Word(53, "afraid", describeCategory, R.drawable.describe_afraid, R.raw.describe_afraid),
            new Word(54, "cloudy", describeCategory, R.drawable.describe_cloudy, R.raw.describe_cloudy),
            new Word(55, "dark", describeCategory, R.drawable.describe_dark, R.raw.describe_dark),
            new Word(56, "five", describeCategory, R.drawable.describe_five, R.raw.describe_five),
            new Word(57, "hilly", describeCategory, R.drawable.describe_hilly, R.raw.describe_hilly),
            new Word(58, "hot", describeCategory, R.drawable.describe_hot, R.raw.describe_hot),
            new Word(59, "old", describeCategory, R.drawable.describe_old, R.raw.describe_old),
            new Word(60, "quiet", describeCategory, R.drawable.describe_quiet, R.raw.describe_quiet),
            new Word(61, "silly", describeCategory, R.drawable.describe_silly, R.raw.describe_silly),
            new Word(62, "six", describeCategory, R.drawable.describe_six, R.raw.describe_six),
            new Word(63, "sixteen", describeCategory, R.drawable.describe_sixteen, R.raw.describe_sixteen),
            new Word(64, "sleepy", describeCategory, R.drawable.describe_sleepy, R.raw.describe_sleepy),
