...
public class DebugStoryRepository implements StoryRepository {
    ...
    @Override
    public List<StoryPage> getStoryPages(int storyId) {
    ...
    @Override
    public StoryPage getStoryPage(int storyId, int pageNumber) {
        for (StoryPage page : storyPages) {
            if (page.getStoryId() == storyId && page.getPageNumber() == pageNumber) {
                return page;
            }
        }
        return null;
