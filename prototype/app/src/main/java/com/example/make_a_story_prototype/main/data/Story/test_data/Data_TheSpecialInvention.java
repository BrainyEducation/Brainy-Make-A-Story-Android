...
public class Data_TheSpecialInvention {
    ...
    private static StoryPage sampleStoryPage1() {
        ...
        segments.add(new StoryBlankIdentifier("A-2"));
        segments.add(new StoryText("  thinking till late at night, so every morning it was hard to wake up in time for school. ", R.raw.special_invention_segment_4));
        segments.add(new StoryBlankIdentifier("A-2"));
        segments.add(new StoryText(" liked inventing things, and they always worked really well---while ", R.raw.special_invention_segment_5));
        segments.add(new StoryBlankIdentifier("A-2"));
        segments.add(new StoryText("  was planning and imagining them---and sometimes almost worked after", R.raw.special_invention_segment_6));
        segments.add(new StoryBlankIdentifier("A-2"));
        segments.add(new StoryText(" actually made them.  A funnel to toss toys in like the ", R.raw.special_invention_segment_7));
        ...
        segments.add(new StoryText(" and the ", R.raw.special_invention_segment_14));
        segments.add(new StoryBlankIdentifier("GG"));
        segments.add(new StoryText(" section on the way to school, and devised the ", R.raw.special_invention_segment_15));
        segments.add(new StoryBlankIdentifier("JJ"));
        segments.add(new StoryText(" unit at school, and imagined the ", R.raw.special_invention_segment_16));
        segments.add(new StoryBlankIdentifier("KK"));
        segments.add(new StoryText(" segment on the way home, and by after school snack time knew the ", R.raw.special_invention_segment_17));
        segments.add(new StoryBlankIdentifier("LL"));
        segments.add(new StoryText("  made the final step and then knew exactly how to create it! Every morning on her way to the kitchen Mom opened the bedroom door to politely say, \"Wake up!\"", R.raw.special_invention_segment_18));
        segments.add(new StoryBlankIdentifier("A-2"));
        segments.add(new StoryText("  tied a string to the door knob, so when the door opened it would drop a toy ", R.raw.special_invention_segment_19));
        segments.add(new StoryBlankIdentifier("EE"));
...
//        segments.add(new StoryText("  on a teeter-totter lever tossing a toy ", R.raw.special_invention_segment_21));
//        segments.add(new StoryBlankIdentifier("GG"));
        ...
        segments.add(new StoryBlankIdentifier("A-2"));
        segments.add(new StoryText("Who could sleep after creating such a magnificatious, splendificatory, brilliastonishing, phenomitastic invention?! Not ", R.raw.special_invention_segment_24));
        segments.add(new StoryBlankIdentifier("A-2"));
        segments.add(new StoryText(", not until very late.  \n"
                + "Too late.", R.raw.special_invention_segment_25));
        segments.add(new StoryBlankIdentifier("A-2"));
        segments.add(new StoryText(" didn’t wake when Mom opened the door and gently suggested, \"Wake up!\"  Didn’t notice the toy ", R.raw.special_invention_segment_26));
        segments.add(new StoryBlankIdentifier("EE"));
        ...
        segments.add(new StoryBlankIdentifier("KK"));
        segments.add(new StoryText(" loose, only smacking the stopper so hard the water didn’t trickle out but shot out like a squirt gun and soaked a toy stuffed ", R.raw.special_invention_segment_30));
        segments.add(new StoryBlankIdentifier("NN"));
        segments.add(new StoryText(" on the edge of the shelf that got so wet heavy it fell on the cat that startled and screeched and leaped up high and knocked its hindquarters into the ", R.raw.special_invention_segment_31));
        segments.add(new StoryBlankIdentifier("LL"));
        segments.add(new StoryText("  so the pin sharp stung the cat’s tail and it howled and claw snatched at the balloon that loud-popped scaring the cat to twist land slap on guess-whose  sleeping face. ", R.raw.special_invention_segment_32));
        segments.add(new StoryBlankIdentifier("A-2"));
