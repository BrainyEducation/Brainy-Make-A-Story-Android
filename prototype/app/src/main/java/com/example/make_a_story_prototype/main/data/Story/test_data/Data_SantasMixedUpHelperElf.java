...
public class Data_SantasMixedUpHelperElf {
    public static Story sampleStory() {
        ...
        return new Story(3,"Santa's Mixed-Up Helper Elf", pages, R.drawable.story_santas_elf_background);
    }
    ...
    private static StoryPage sampleStoryPage1() {
        ...
        segments.add(new StoryText("\tLate one Christmas Eve, frazzled and exhausted and sleepy-tired more "
                ...
                + "in their own home anymore and don’t have any place else to go. Staying there means they don’t "
        ...
        segments.add(new StoryText(" big enough to sit and rock and pretend to ride far away.\n\n"
        ...
        segments.add(new StoryText(" wanted most a brand new ", R.raw.santas_helper_elf_segment_8));
        ...
        segments.add(new StoryText(". \n\n\tTimid helper-elf Elmer felt terribly, horribly awful that he’d found the "
    ...
    private static StoryPage sampleStoryPage2() {
        ...
        segments.add(new StoryText(" to carry a big wooden ", R.raw.santas_helper_elf_segment_12));
        ...
        segments.add(new StoryText("\n\n\t- for ", R.raw.santas_helper_elf_segment_16));
        segments.add(new StoryBlankIdentifier("C-2"));
        ...
        segments.add(new StoryText(".\n\n"
                ...
                + "and discovered —oh no!— he had made a mistake on every… single… gift. Elmer crumpled down to the floor "
